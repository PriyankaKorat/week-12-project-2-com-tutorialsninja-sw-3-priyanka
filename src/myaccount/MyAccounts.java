...
public class MyAccounts extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully(){
        ...
        //3.3 Enter First Name
        sendTextElement(By.id("input-firstname"),"Priyanka");

        //3.4 Enter Last Name
        sendTextElement(By.id("input-lastname"),"Korat");

        //3.5 Enter Email
        final String randomEmail = randomEmail();
        sendTextElement(By.id("input-email"), randomEmail);

        //3.6 Enter Telephone
        sendTextElement(By.id("input-telephone"),"9184561234");

        //3.7 Enter Password
        sendTextElement(By.id("input-password"),"12345678");

        //3.8 Enter Password Confirm
        sendTextElement(By.xpath("//input[@id='input-confirm']"),"12345678");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        sendTextElement(By.id("input-email"),"sanganipriyanka8@gmail.com");
