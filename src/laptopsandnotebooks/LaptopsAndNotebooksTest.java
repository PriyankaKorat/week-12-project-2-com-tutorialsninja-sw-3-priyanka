...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextElement(By.xpath("//input[@class='form-control']"), "2");
        ...
        //Verify the Total $2,404.00
        Assert.assertEquals("$2,404.00", getTextFromTheElement(By.xpath("//tbody//tr//td[6]")));
        ...
        String actNewCust = getTextFromTheElement(By.xpath("//h2[normalize-space()='New Customer']"));
        Assert.assertEquals("Invalid success message",expNewCust,actNewCust);
        ...
        sendTextElement(By.id("input-payment-firstname"), "Beena");
        sendTextElement(By.id("input-payment-lastname"), "Rani");
        sendTextElement(By.id("input-payment-email"), "imthebest@gmail.com");
        sendTextElement(By.id("input-payment-telephone"), "1234567890");
        sendTextElement(By.id("input-payment-address-1"), "60 waterhouse eet");
        sendTextElement(By.id("input-payment-city"), "Milton keynes");
        sendTextElement(By.id("input-payment-postcode"), "kt25eg");
        ...
        sendTextElement(By.xpath("//textarea[@name='comment']"), "I want a macbook");
