...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() {
        ...
        sendTextElement(By.name("quantity"), "1");
        //2.10 Click on “Add to Cart” button
        ...
        //2.13 Verify the text "Shopping Cart"
        Assert.assertEquals("Shopping Cart  (1.00kg)", getTextFromTheElement(By.xpath("//h1[contains(text(),'Shopping Cart')]")));
        //2.14 Verify the Product name "HP LP3065"
        Assert.assertEquals("HP LP3065", getTextFromTheElement(By.linkText("HP LP3065")));
        ...
        //2.16 Verify the Model "Product21"
        Assert.assertEquals("Product 21", getTextFromTheElement(By.xpath("//td[normalize-space()='Product 21']")));
        //2.17 Verify the Todat "£74.73"
